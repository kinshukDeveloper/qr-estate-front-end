...
interface Props {
  ...
  isLoading: boolean;
  isEdit?: boolean;
  /** Optional element rendered next to the Description label (e.g. AI Write button) */
  descriptionExtra?: React.ReactNode;
}

export function ListingForm({ defaultValues, onSubmit, isLoading, isEdit, descriptionExtra }: Props) {
  const {
    register,
    handleSubmit,
    watch,
